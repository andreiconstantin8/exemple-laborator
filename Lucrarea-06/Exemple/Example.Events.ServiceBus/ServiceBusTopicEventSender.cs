...
namespace Exemple.Events.ServiceBus
{
    public class ServiceBusTopicEventSender : IEventSender, IAsyncDisposable
    {
        ...
        public static CloudEvent CreateCloudEvent<T>(string topicName, T eventPayload)
        {
            ...
            cloudEvent.Source = new("https://localhost:44322/swagger/index.html");
            return cloudEvent;
        }
